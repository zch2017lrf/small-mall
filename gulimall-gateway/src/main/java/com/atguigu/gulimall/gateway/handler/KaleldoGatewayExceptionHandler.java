package com.atguigu.gulimall.gateway.handler;
 ...
 */
@Slf4j
public class KaleldoGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public KaleldoGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties, ErrorProperties errorProperties, ApplicationContext applicationContext) {
